...
/**
 * View manager adapted from PeasyCam Processing library by 
...
public class PTCamera {
	...
	public DragHandler getPanDragHandler() {
		return panHandler;
	}

	public DragHandler getRotateDragHandler() {
		return rotateHandler;
	}

	public DragHandler getZoomDragHandler() {
		return zoomHandler;
	}

	public WheelHandler getZoomWheelHandler() {
		return zoomWheelHandler;
	}

	public void setLeftDragHandler(final DragHandler handler) {
		leftDragHandler = handler;
	}

	public void setCenterDragHandler(final DragHandler handler) {
		centerDragHandler = handler;
	}

	public void setRightDragHandler(final DragHandler handler) {
		rightDraghandler = handler;
	}

	public WheelHandler getWheelHandler() {
		return wheelHandler;
	}

	public void setWheelHandler(final WheelHandler wheelHandler) {
