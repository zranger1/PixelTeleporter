/* 
// Walled cube pixel map generator for Pixelblaze.
// Replaces the default walled cube mapper.  This one allows
// you to specify all three dimensions and is "wired" in a
// very simple linear fashion.
//
